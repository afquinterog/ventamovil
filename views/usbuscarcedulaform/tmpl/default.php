                        ...
                        <form action="index.php" method="post" class="contactForm" id="contactForm">
                            <fieldset>
								...
								<div class="formFieldWrap">
                                    <label class="field-title contactNameField" for="cedula">C&eacute;dula:<span></span></label>
                                    <input type="number" name="cedula" value="" class="contactField requiredField" id="cedula"/>
                                </div>
