...
$filter = "".$filter."%";
$query = sprintf( $query, $filter, $user);
...
while ($data = $result->fetch_object() ) {
	...
	$autocomplete->name = utf8_encode( $data->descripcion );
	$info[] = $autocomplete;
}
...
//echo '[{"name":"Andres Felipe Quintero","id":"1"},{"name":"Trading Spouses","id":"f5f7ee41d8766edb1a3a67da05f057ac"}]';
